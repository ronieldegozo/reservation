<div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="has_sub">
			<a href="#"><i class="fa fa-calendar"></i> Reservation  <span class="pull-left"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
          ...
          <li class="has_sub">
			<a href="#"><i class="fa fa-file-o"></i> Maintenance  <span class="pull-left"><i class="fa fa-chevron-right"></i></span></a>
            <ul>			
		  ...
		  <li class="has_sub"><a href="#"><i class="fa fa-bar-chart-o"></i> Report  <span class="pull-left"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
